  ...
  {showDemo && !DemoClosed  && (
    ...
    <div className="animate-slideInRight  flex items-center bg-gray-950 text-white py-2 px-2 rounded-l-lg shadow-lg relative  ">
      <Link
        ...
        className=" bg-white  text-black rounded px-2 mr-5 py-1 text-[13px] font-semibold flex items-center gap-1 w-full"
      >       
      {t('contact')} <FaWpforms className='text-lg rotate-6' />
      </Link>
